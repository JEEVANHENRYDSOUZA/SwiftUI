...
struct ContentView: View {
    ...
    var body: some View {
        ...
        Chart{
            ...
            BarMark(x: PlottableValue.value("Value",50),
                    y: PlottableValue.value("Label 1","Day 1"))
            
            BarMark(x: PlottableValue.value("Value",25),
                    y: PlottableValue.value("Label 2","Day 2"))
        ...
        //charts again have iteration feature 
